...
if ~exist('IMG','var')
    ...
    grinmat = '/Users/bradleymonk/Documents/MATLAB/GIT/grin/grindata/grin_compressed/gc93/GRIM_gc93_2017_0719_g.mat';
    ...
    IMG = double(INIM.IMGC);
    IMR = double(INIM.IMRC);
    GRINstruct = INIM.INFO;
    XLSdata = INIM.XLSD;
    LICK = INIM.LICK;
...
IMGSraw = mean(squeeze(mean(IMG,4)),3);
